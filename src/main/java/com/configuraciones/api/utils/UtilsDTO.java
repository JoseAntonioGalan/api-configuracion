...
/**
 * Clase de utilidad para la conversión entre entidades y DTOs relacionados con
 * Configuraciones.
 */
@Slf4j
public class UtilsDTO {
    ...
    /**
     * Convierte una lista de entidades ConfigGrupo a una lista de DTOs
     * ConfigGrupoDTO.
     *
    ...
    public static List<ConfigGrupoDTO> obtenerListaDeEntidadConfigGrupo(List<ConfigGrupo> listaConfigGrupo) {
        ...
        log.info(msg + " - init");
        List<ConfigGrupoDTO> listaConfigGrupoDto = null;

        if (listaConfigGrupo != null) {
            listaConfigGrupoDto = new ArrayList<>();
        ...
        log.info(msg + " - end. Resultado: " + (listaConfigGrupoDto != null ? listaConfigGrupoDto.size() : null));
        return listaConfigGrupoDto;
    }

    /**
     * Convierte una lista de entidades ConfigParam a una lista de DTOs
     * ConfigParamDTO.
     *
    ...
    public static List<ConfigParamDTO> obtenerListaDeEntidadConfigParam(List<ConfigParam> listaConfigParam) {
        ...
        log.info(msg + " - init");
        List<ConfigParamDTO> listaConfigParamDto = null;

        if (listaConfigParam != null) {
            listaConfigParamDto = new ArrayList<>();
            for (ConfigParam configParam : listaConfigParam) {
                listaConfigParamDto.add(new ConfigParamDTO(configParam));
            }
        }

        log.info(msg + " - end. Resultado: " + (listaConfigParamDto != null ? listaConfigParamDto.size() : null));
